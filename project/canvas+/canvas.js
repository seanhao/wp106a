$(function () {
            ...
            $.each(colors, function (i, v) {
                sb.push("<div class='option w3-bar-item w3-button w3-padding-large ' style='background-color:" + v + "'></div>");
            });
            $("#dPallete").html(sb.join("\n"));
            //產生不同尺寸的方格當作線條粗細選項
            sb = [];
            for (var i = 11; i <= 19; i++)
                sb.push("<div class='option w3-bar-item w3-button w3-padding-large'>" +
